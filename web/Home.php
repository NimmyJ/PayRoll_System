		...
		<!-- header-starts -->
			...
			<!--/down-->
                           ...
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>New Employee</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										  <ul id="menu-academico-sub" >
