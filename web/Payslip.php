...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	if(empty($_POST["empId"])){
		$errName="** Enter Employee Id";
		$valid = false;
    }
    
    $sql="SELECT * FROM employee WHERE id = '".$_POST["empId"]."'";
        ...
        <table class=\"table table-striped\" border=\"2\">
            <tr >
                <td colspan=\"2\" class=\"text-center\">
                    <b>Payment Details of Employee: MoneyFix International Inc.</b>
                </td>
            </tr>
            <tr>
                <td>This document is protected and very secure in nature. Don't share with anyone. Organization is not responsible for any harms that can be caused</td>
            ...
            <tr>
                ...
                <td>
                    <table class=\"table table-hover\">
                        ...
                        <tbody>
                        <tr>
                            <td>Manager(MoneyFix International inc)</td>
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<div class="left-side sticky-left-side">
					...
					<div class="logo" style="background-color: yellow;text-align: center;">
						<h1><a href="index.php">Payment Slip</a></h1>
					</div>
    ...
    <!-- main content start-->
		<div class="main-content main-content3">
			...
			<div class="menu-right" style="background-color: darkblue">
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/nimmy.jpg) no-repeat center"> </span> 
										 <div class="user-name">
											<p style="color: white">Nimmy Jose<span>Administrator</span></p>
										 </div>
										 <i class="lnr lnr-chevron-down" style="color:white"></i>
										 <i class="lnr lnr-chevron-up" style="color:white"></i>
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Generate Pay Slip</h3>
							...
							<form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
								<div class="form-group">
									...
									<div class="col-sm-2 jlkdfj1">
										<p class="help-block" style="color: red"><?php echo ($errName);?></p>
									</div>
                                </div>
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col-sm-8 col-sm-offset-2">
											<button class="btn-success btn" style="background-color: darkblue">Submit</button>
...
<div class="col-md-9">
    ...
    <table class="table table-striped" border="2">
        <tr >
            <td colspan="2" class="text-center" style="background-color: blue">
                <b>Payment Details of Employee: MoneyFix International Inc.</b>
            </td>
        </tr>
        <tr>
...
<button class="btn-success btn"  name="download" value="download" style="margin-bottom: 100px;background-color: darkblue">Download</button></div>
